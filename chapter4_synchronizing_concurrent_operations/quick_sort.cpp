...
// void worker(queue<Task>& task_q, mutex& mtx, vector<int>& nums) {
//   while (true) {
//     Task t;
//     bool has_task = false;
//     {
...
void test_quicksort_sequential() {
  // Note:
  ...
  for (int i=0; i<10000; i++) {
    ...
    quicksort_sequential(0, nums_cpy2.size()-1, nums_cpy2);
    bool failed = false;
